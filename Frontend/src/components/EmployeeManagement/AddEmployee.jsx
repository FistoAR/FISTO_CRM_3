...
const AddEmployee = ({ editingEmployee, onSuccess, onCancel }) => {
  ...
  useEffect(() => {
    if (editingEmployee) {
      console.log("Loading editing employee:", editingEmployee);
      ...
      setFormData({
        ...
        emailPersonal: editingEmployee.emailPersonal || "",
        emailOfficial: editingEmployee.emailOfficial || "",
        phonePersonal: editingEmployee.phonePersonal || "",
        phoneOfficial: editingEmployee.phoneOfficial || "",
        designation: editingEmployee.designation || "",
        teamHead: editingEmployee.team_head || false,
        employmentType: editingEmployee.employmentType || "On Role",
        workingStatus: editingEmployee.workingStatus || "Active",
        doj: editingEmployee.doj || "",
        internStartDate: editingEmployee.internStartDate || "",
        internEndDate: editingEmployee.internEndDate || "",
        durationMonths: editingEmployee.durationMonths || "",
        ...
        probation: null,
        otherDocs: [],
        existingProfile: editingEmployee.profile || null,
        existingResume: editingEmployee.resume || null,
      ...
      if (editingEmployee.profile) {
        setProfilePreview(
          `${import.meta.env.VITE_API_BASE_URL1}${editingEmployee.profile}`
        );
      }
    }
  }, [editingEmployee]);
  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(async () => {
      ...
      try {
        const res = await fetch(
          `${import.meta.env.VITE_API_BASE_URL}/employeeRegister/check/${formData.userName}`
        );
  ...
  const validateForm = () => {
    ...
    } else if (formData.employmentType === "Intern") {
      if (!formData.internStartDate)
        newErrors.internStartDate = "Intern start date is required";
      if (!formData.internEndDate)
        newErrors.internEndDate = "Intern end date is required";
    }

    setErrors(newErrors);
    return (
      Object.keys(newErrors).length === 0 &&
      (editingEmployee || usernameAvailable)
    );
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = editingEmployee
        ? `${import.meta.env.VITE_API_BASE_URL}/employeeRegister/updateEmployee/${editingEmployee.userName}`
      ...
      <div>
        ...
        {hasExisting && !formData[fieldName] && (
          <div className="mb-[0.5vw] flex items-center gap-[0.5vw] p-[0.5vw] bg-green-50 rounded-lg border border-green-200">
            ...
            <a
              href={`${import.meta.env.VITE_API_BASE_URL1}${hasExisting}`}
              target="_blank"
        ...
        {formData[fieldName] && (
          <p className="text-green-600 text-[0.75vw] mt-[0.3vw] flex items-center gap-[0.3vw]">
            <span>✓</span> {formData[fieldName].name}
          </p>
        )}
      </div>
    );
  ...
  return (
    <div className="h-full flex flex-col bg-gray-50">
      ...
      <div className="flex-1 overflow-y-auto px-[1.2vw] py-[1vw]">
        <form onSubmit={handleSubmit} className="max-w-[75vw] mx-auto space-y-[1vw]">
            ...
            {expandedSections.basicInfo && (
              <div className="p-[1.2vw]">
                ...
                <div className="grid grid-cols-3 gap-[1vw]">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-[2.5vw] pr-[0.8vw] py-[0.5vw] border rounded-full text-[0.9vw] uppercase focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent placeholder:text-gray-800 placeholder:text-[0.85vw] transition-all ${
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className={`w-full pl-[2.5vw] pr-[0.8vw] py-[0.5vw] border rounded-full text-[0.9vw] focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent placeholder:text-gray-800 placeholder:text-[0.85vw] transition-all ${
                          errors.employeeName
                            ? "border-red-500"
                            : "border-gray-700"
                        }`}
                  ...
                  {/* Gender - Spans across all 3 columns */}
                    ...
                    <div className="flex gap-[1.5vw]">
                      {["Male", "Female", "Other"].map((gender) => (
                        ...
                        >
                          ...
                          />
                          <span className="ml-[0.4vw] text-[0.9vw] text-gray-700">
                            {gender}
                          </span>
                        </label>
                      ))}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className="w-full pl-[2.5vw] pr-[0.8vw] py-[0.5vw] border border-gray-700 rounded-full text-[0.9vw] focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent placeholder:text-gray-800 placeholder:text-[0.85vw] transition-all"
                  ...
                  {/* Error Messages for Email/Phone */}
                    ...
                    <div className="col-span-2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={handleInputChange}
                          className={`w-full pl-[2.5vw] pr-[2.5vw] py-[0.5vw] border rounded-full text-[0.9vw] focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent placeholder:text-gray-800 placeholder:text-[0.85vw] transition-all ${
                            errors.password
                              ? "border-red-500"
                              : "border-gray-700"
                          }`}
                  ...
                  <div className="col-span-3">
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        onChange={handleInputChange}
                        rows="2"
                        className="w-full pl-[2.5vw] pr-[0.8vw] py-[0.5vw] border border-gray-700 rounded-lg text-[0.9vw] focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent resize-none placeholder:text-gray-800 placeholder:text-[0.85vw] transition-all"
            ...
            {expandedSections.employment && (
              <div className="p-[1.2vw]">
                ...
                <div className="grid grid-cols-3 gap-[1vw]">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        className={`w-full pl-[2.5vw] pr-[0.8vw] py-[0.5vw] border rounded-full text-[0.9vw] focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent cursor-pointer appearance-none transition-all ${
                          errors.designation
                            ? "border-red-500"
                            : "border-gray-700"
                        } ${
                  ...
                  {/* Date of Joining (On Role) or Duration (Intern) */}
                  {formData.employmentType === "On Role" ? (
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={handleInputChange}
                          className={`w-full pl-[2.5vw] pr-[0.8vw] py-[0.5vw] border rounded-full text-[0.9vw] focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all ${
                            errors.doj ? "border-red-500" : "border-gray-700"
                          }`}
                        />
                      </div>
                      {errors.doj && (
                    ...
                    <>
                      <div>
                        <label className="block text-[0.92vw] font-semibold text-gray-900 mb-[0.4vw]">
                          Intern Start <span className="text-red-500">*</span>
                        </label>
                        <div className="relative">
                          <Calendar className="w-[1vw] h-[1vw] absolute left-[0.8vw] top-1/2 -translate-y-1/2 text-gray-400" />
                          <input
                      ...
                      <div>
                        <label className="block text-[0.92vw] font-semibold text-gray-900 mb-[0.4vw]">
                          Intern End <span className="text-red-500">*</span>
                        </label>
                        <div className="relative">
                          <Calendar className="w-[1vw] h-[1vw] absolute left-[0.8vw] top-1/2 -translate-y-1/2 text-gray-400" />
                          <input
                      ...
                      <div>
                        ...
                        <input
                          ...
                          readOnly
                          className="w-full px-[0.8vw] py-[0.5vw] border border-gray-700 rounded-full bg-gray-100 cursor-not-allowed text-[0.9vw] text-gray-600"
                  ...
                  {expandedDocSections.otherDocs && (
                    <div className="p-[0.8vw] bg-white">
                            ...
                            <div className="space-y-[0.4vw]">
                              {formData.existingOtherDocs.map((doc, idx) => (
                                ...
                                >
                                  ...
                                  <a
                                    href={`${import.meta.env.VITE_API_BASE_URL}${doc.path}`}
                                    target="_blank"
                                    rel="noopener noreferrer"
                      ...
                      <input
                        ...
                        className="w-full text-[0.9vw] border border-gray-700 rounded-lg py-[0.4vw] px-[0.6vw] file:mr-[0.8vw] file:py-[0.4vw] file:px-[0.8vw] file:rounded-full file:border-0 file:text-[0.85vw] file:font-semibold file:bg-gray-900 file:text-white hover:file:bg-gray-800 cursor-pointer"
                      />
                      {formData.otherDocs.length > 0 && (
                        <p className="text-green-600 text-[0.75vw] mt-[0.4vw] flex items-center gap-[0.3vw]">
                          <span>✓</span> {formData.otherDocs.length} new
                          file(s) selected
                        </p>
                      )}
                    </div>
      ...
      <div className="flex-shrink-0 bg-white border-t border-gray-200 px-[1.2vw] py-[0.8vw]">
        <div className="max-w-[75vw] mx-auto flex gap-[0.8vw]">
          <button
            type="button"
            onClick={onCancel}
