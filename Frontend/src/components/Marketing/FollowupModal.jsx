...
import { X, History, Calendar, ArrowLeft, Plus } from "lucide-react";
...
const FollowupModal = ({
  ...
  const handleSubmit = async () => {
    ...
    if (status === "") {
      alert("Please select the status before submit");
      return;
    }
