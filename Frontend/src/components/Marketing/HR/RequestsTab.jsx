                      ...
                      {req.status === "pending" ? (
                        <div className="flex justify-center items-center gap-[0.5vw]">
                          <button
                            ...
                            className="px-[0.8vw] py-[0.35vw] flex items-center justify-center gap-[0.3vw] bg-green-600 text-white rounded-full text-[0.75vw] hover:bg-green-700 cursor-pointer transition-all"
                          >
                          ...
                          <button
                            ...
                            className="px-[0.8vw] py-[0.35vw] flex items-center justify-center gap-[0.3vw] bg-red-600 text-white rounded-full text-[0.75vw] hover:bg-red-700 cursor-pointer transition-all"
                          >
                            <XCircle size={"0.9vw"} />
                            <span>Reject</span>
                          </button>
