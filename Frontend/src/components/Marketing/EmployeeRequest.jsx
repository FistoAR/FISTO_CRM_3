...
const EmployeeRequest = () => {
  ...
  const clearForm = () => {
    setFormData({
      ...
      meetingDetails: "", meetingDate: "", meetingFromTime: "", meetingToTime: "", meetingDuration: "", attendees: [], meetingDescription: "",
    });
  };
          ...
          <div className="space-y-[1vw]">
            ...
            <div className="grid grid-cols-2 gap-[1vw]">
              ...
              <div className="flex flex-col">
                ...
                <input
                  type="text"
                  value={formData.meetingDuration ? `${formData.meetingDuration} mins` : ""}
                  readOnly
                  className="px-[0.7vw] py-[0.5vw] text-[0.85vw] border border-gray-300 rounded-lg bg-gray-50"
                />
              </div>
            ...
            <div className="flex flex-col">
              ...
              <select
                onChange={(e) => {
                  ...
                  if (selectedId) {
                    ...
                    if (selectedEmployee && !formData.attendees.find(a => a.employee_id === selectedId)) {
              ...
              >
                ...
                {employees
                  .filter(emp => !formData.attendees.find(a => a.employee_id === emp.employee_id))
                  .map((emp) => (
      ...
      <div className="w-[100%] h-[91vh] flex flex-col gap-[1vh]">
        ...
        <div className="bg-white flex justify-between overflow-hidden rounded-xl shadow-sm h-[6%] flex-shrink-0">
          <div className="flex border-b border-gray-200 h-full w-full">
            ...
            <button
              onClick={() => { setMainTab("scheduleMeeting"); clearForm(); }}
